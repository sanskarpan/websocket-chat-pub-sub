...
type IRoomRepository interface {
	...
	CreateRoomWithOwner(ctx context.Context, room *model.Room, owner *model.RoomMember) error
...
type IMessageRepository interface {
	...
	UpdateReactionsTx(ctx context.Context, msgID string, transform func(current map[string][]string) (map[string][]string, error)) error
